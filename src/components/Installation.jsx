...
const Installation = () => {
  ...
  const CodeBlock = ({ children, language = "bash" }) => (
    <div className="bg-gray-900 rounded-lg p-3 sm:p-4 my-2 sm:my-3 overflow-x-auto">
      <code className="text-green-400 text-sm sm:text-base font-mono whitespace-pre">
        {children}
      </code>
    </div>
  );
  ...
  const Section = ({
    ...
    return (
      <div
        ...
        style={{ borderColor: "#374151", backgroundColor: "#1f2937" }}
      >
        <button
          onClick={() => toggleSection(id)}
          className="w-full px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between hover:opacity-90 transition-colors"
          style={{
            background:
              "linear-gradient(to right, rgba(46, 230, 247, 0.1), rgba(46, 230, 247, 0.2))",
          }}
        >
  ...
  const Step = ({ number, title, children }) => (
    <div className="mb-4 sm:mb-6">
      <div className="flex items-center mb-2 sm:mb-3">
        <div
          className="text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3"
          style={{ backgroundColor: "#2ee6f7" }}
        >
          {number}
        </div>
      ...
      <div className="ml-9 sm:ml-11">{children}</div>
    </div>
  );
  ...
  return (
    <section id="Installation">
      <div
        className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 min-h-screen min-w-[99vw]"
        style={{
      ...
      >
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h1
            ...
            style={{
              background: "linear-gradient(to right, #2ee6f7, #0ea5e9)",
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-300">
            Ultra-Modern AI Discord Bot Installation Guide
          </p>
        </div>
        ...
        <Section id="quickstart" title="Quick Start" icon={Zap}>
          <div className="mb-6">
            ...
            >
              <Prerequisite>
                <strong>Node.js</strong> v16.0.0 or higher
              </Prerequisite>
              <Prerequisite>
                <strong>MongoDB</strong> database (local or cloud)
              </Prerequisite>
              <Prerequisite>
                <strong>Discord Bot Token</strong> (Get one{" "}
                <a
                  href="#"
              ...
              <Prerequisite>
                <strong>Google Gemini API Key</strong> (Get one{" "}
                <a
                  href="#"
                  className="hover:underline"
                  style={{ color: "#2ee6f7" }}
        ...
        <Section id="render" title="Deploy to Render (Free)" icon={Cloud}>
          ...
          <Step number="1" title="Prepare Your Repository">
            <div className="text-gray-300">
              ...
              <p>
                2. Clone your fork locally and configure your{" "}
                <code
                  className="px-2 py-1 rounded"
                  style={{ backgroundColor: "#4b5563" }}
                >
...
Start Command: node index.js`}
          ...
          <Step number="3" title="Set Environment Variables">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
                  <code className="text-sm text-gray-200">DISCORD_TOKEN</code> -
                  Your Discord bot token
                </div>
                <div>
                  <code className="text-sm text-gray-200">CLIENT_ID</code> -
                  Your bot's client ID
                </div>
                <div>
                  <code className="text-sm text-gray-200">MONGODB_URI</code> -
                  Your MongoDB connection string
                </div>
                <div>
                  <code className="text-sm text-gray-200">GEMINI_API_KEY</code>{" "}
          ...
          <div
            ...
            style={{
              backgroundColor: "rgba(46, 230, 247, 0.1)",
              borderColor: "#2ee6f7",
            }}
          >
            <h4 className="font-semibold mb-2" style={{ color: "#0891b2" }}>
              💡 Render Configuration Tips
            </h4>
            <ul className="space-y-1" style={{ color: "#0e7490" }}>
              <li>
                <strong>Auto-Deploy:</strong> Enable auto-deploy for seamless
                updates
              </li>
              <li>
                <strong>Health Check:</strong> Set health check path to{" "}
                <code>/</code> if you add a web endpoint
              </li>
              <li>
                <strong>Environment:</strong> Production environment for better
                performance
              </li>
              <li>
                <strong>Scaling:</strong> Free tier includes 512MB RAM and
                shared CPU
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div style={{ color: "#0e7490" }}>
                ...
                <p>
                  3. Get connection string and add to{" "}
                  <code
                    className="px-1 rounded"
                    style={{ backgroundColor: "rgba(46, 230, 247, 0.2)" }}
                  >
                    .env
                  </code>
                </p>
            ...
            <div
              ...
              style={{
                borderColor: "#2ee6f7",
                backgroundColor: "rgba(46, 230, 247, 0.05)",
              }}
            >
              <h4 className="font-semibold mb-2" style={{ color: "#0891b2" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-300">
                  <strong>Automatic Schema Creation</strong> - Tables created
                  automatically
                </span>
              </div>
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-300">
                  <strong>Data Persistence</strong> - All user data, XP, points,
                  tickets stored
                </span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-gray-400 rounded-full mr-2"></div>
                <span className="text-sm text-gray-300">
                  <strong>Backup Ready</strong> - Easy export/import
                  capabilities
                </span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-gray-400 rounded-full mr-2"></div>
                <span className="text-sm text-gray-300">
                  <strong>Scalable</strong> - Handles unlimited users and
                  servers
                </span>
              </div>
            </div>
...
- Role automation: Enable/Disable`}
            ...
            >
              <h4 className="font-semibold mb-3" style={{ color: "#0891b2" }}>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span style={{ color: "#0e7490" }}>
                    <strong>Daily Rewards:</strong> 50-200 points daily
                  </span>
                </div>
                <div className="flex items-center">
                  <Trophy
                  ...
                  />
                  <span style={{ color: "#0e7490" }}>
                    <strong>Point Trading:</strong> Users can gift points
                  </span>
                </div>
                <div className="flex items-center">
                  <Trophy
                  ...
                  />
                  <span style={{ color: "#0e7490" }}>
                    <strong>Leaderboards:</strong> Server-wide rankings
                  </span>
                </div>
                <div className="flex items-center">
                  <Trophy
                  ...
                  />
                  <span style={{ color: "#0e7490" }}>
                    <strong>Future Ready:</strong> Framework for point shops
                  </span>
                </div>
              </div>
            </div>
        ...
        {/* Footer */}
        <div
          className="text-center mt-8 p-6 rounded-lg shadow-sm"
          style={{ backgroundColor: "#1f2937" }}
        >
          <p className="text-gray-300">
            🚀 Ready to deploy your VAISH Discord Bot? Follow the steps above
